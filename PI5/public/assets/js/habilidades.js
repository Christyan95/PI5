...
const sobreSkill = [
                    ...
                    '<p>Arduino</p> <br> <p>É uma plataforma de prototipagem eletrônica de hardware livre e de placa única, projetada com um microcontrolador.</p> <br>',
                    '<p>Github</p> <br> <p>É uma plataforma de hospedagem de código-fonte e arquivos com controle de versão usando o Git. </p> <br>',
                    
                    '<p>Java</p> <br> <p>É uma linguagem multiplataforma, orientada a objetos e centrada em rede que pode ser usada como uma plataforma em si.</p> <br>',
                    '<p>SQL</p> <br> <p>É a linguagem de pesquisa declarativa padrão para banco de dados relacional.</p> <br>',
                    ...
                    '<p>Node</p> <br> <p>     </p> <br>',
                    '<p>PHP</p> <br> <p>     </p> <br>',
                    '<p>BootStrap</p> <br> <p>     </p> <br>',
                    '<p>TypeScript</p> <br> <p>     </p> <br>'
]
const dataInicio = [
